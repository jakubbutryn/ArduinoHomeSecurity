...
const char* serverName1 = "http://192.168.0.136/inzynierka/TurnOnHeating.json";
const char* serverName2 = "http://192.168.0.136/inzynierka/SetTemperature.json";
const char* serverName3 = "http://192.168.0.136/inzynierka/TurnOnAlarm.json";
...
//String SerialToSend=String(TurnOnAlarm) + String(TurnOnHeating) + String(SetTemperature);
//Serial.print(SerialToSend);
/////////SetTemperature/////////
http.begin(client, serverName2);
 payload = http.getString();
 error = deserializeJson(doc, payload);
const char* SetTemperature = doc["TurnOnHeating"]; // "yes"
http.end();
...
http.begin(client, serverName3);
 payload = http.getString();
 error = deserializeJson(doc, payload);
const char* TurnOnAlarm = doc["TurnOnHeating"]; // "yes"
http.end();
if(String(TurnOnHeating)=="ON"){
  Serial.print("OKS");
}
